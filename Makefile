...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
PROG_URL            := https://github.com/progman/libxlwriter.git
PROG_NAME           := test
PROG_VERSION        := 0.0.2
PROG_TYPE           := exe
...
OUT_DIR             := bin
C_LIST              :=
CPP_LIST            := submodule/libcore.cpp/libcore.cpp libxlwriter.cpp test.cpp
HEADER_LIST         := submodule/libcore.cpp/libcore.hpp libxlwriter.hpp
